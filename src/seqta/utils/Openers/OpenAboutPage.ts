...
export function OpenAboutPage() {
  ...
  let text = stringToHTML(/* html */ `
      <div class="whatsnewTextContainer" style="overflow-y: scroll;">
        ...
        <p>We are currently working on fixing bugs and adding Useful features. If you want to make a feature request or report a bug, you can do so on GitHub (find icon below). We are always looking for more coders!</p>
        <h1>Credits:</h1>
